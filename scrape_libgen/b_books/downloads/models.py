...
class Books(models.Model):
    ...
    Author = NameField(max_length=5000)
    Author_original = models.CharField(max_length=5000)
    Title = models.CharField(max_length=5000)
    Publisher = models.CharField(max_length=5000)
    Year_published = models.CharField(max_length=5000)
    num_Pages = models.CharField(max_length=5000)
    Language = models.CharField(max_length=5000)
    Size = models.CharField(max_length=5000)
    Extension = models.CharField(max_length=5000)
    Mirrors = models.URLField(max_length=50000)
